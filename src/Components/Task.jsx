...
const Task = ({ dark_Mode, task, delete_Task }) => {
  ...
  return (
    <div className="flex px-3 md:px-4 lg:px-6 py-4 gap-3.5 lg:gap-5 items-center border-b-1 border-b-dark_Grey_Blue"
      ...
      <button className="portrait:block hidden" ref={del_Btn} onClick={() => delete_Task(task.id)}>
