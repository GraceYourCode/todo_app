const Nav_Bar = ({dark_Mode, setTheme}) => {
  return (
    <nav className="flex items-center justify-between">
      <header className="text-white text-2xl lg:text-3xl lg:tracking-widest md:tracking-wider tracking-wide font-bold body">TODO</header>
      <button onClick={()=>setTheme()} className="outline-none">
        {dark_Mode?
